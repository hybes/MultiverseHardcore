...
public class HelpCommand implements CommandExecutor {
    ...
    public static final String CREATE_COMMAND = ChatColor.BLUE + "/mvhc" + ChatColor.GREEN + " create" + ChatColor.RED
            + " <world>" + ChatColor.GRAY + " - launches setup wizard" + ChatColor.RESET;

    public static final String CREATE_COMMAND_FULL = ChatColor.BLUE + "/mvhc" + ChatColor.GREEN + " create" + ChatColor.RED
            + " <world>" + ChatColor.GOLD + " [spectator] [nether] [end] [ban_forever] " +
            "[ban_length] [inc_nether] [inc_end] [respawn_world]" + ChatColor.RESET;

    public static final String MAKE_COMMAND = ChatColor.BLUE + "/mvhc" + ChatColor.GREEN + " makehc" + ChatColor.RED +
            " <world>" + ChatColor.GRAY + " - launches setup wizard" + ChatColor.RESET;

    public static final String MAKE_COMMAND_FULL = ChatColor.BLUE + "/mvhc" + ChatColor.GREEN + " makehc" + ChatColor.RED +
            " <world>" + ChatColor.GOLD + " [spectator] [ban_forever] [ban_length] " +
            "[inc_nether] [inc_end] [respawn_world]" + ChatColor.RESET;
    ...
    public static void printHelpDialog(@NotNull CommandSender sender) {
        ...
        message.append(ChatColor.DARK_RED).append(ChatColor.BOLD).append("━━━ MultiverseHardcore Help ━━━").append(ChatColor.RESET).append("\n");
        if (sender.isOp()) {
            ...
            message.append(ChatColor.DARK_GRAY).append("Tip: Add just a world name to use the interactive setup wizard.");
        } else {
