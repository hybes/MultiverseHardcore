package dev.hybes.multiversehardcore.utils;
...
import dev.hybes.multiversehardcore.exceptions.PlayerParticipationAlreadyExistsException;
...
public final class WorldUtils {
    ...
    private static GameMode getDefaultGameMode(World world) {
        WorldManager worldManager = MultiverseHardcore.getInstance().getWorldManager();
        if (worldManager == null) return GameMode.SURVIVAL;
        return worldManager.getWorld(world.getName())
                .map(MultiverseWorld::getGameMode)
